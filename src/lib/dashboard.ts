...
export type Chat = {
  ...
  waitHours: number; verification: boolean; commentGate: boolean; deleteJoinMessages: boolean; lockCommands: boolean; lockLinks: boolean; lockMedia: boolean; lockForwards: boolean; discussionChatId: string | null;
};
...
export function sampleDashboard(): DashboardData {
  const chat: Chat = { id: "-100000000001", title: "کانال نمونهٔ گفتگو", type: "channel", username: null, active: true, waitHours: 24, verification: true, commentGate: true, deleteJoinMessages: false, lockCommands: false, lockLinks: false, lockMedia: false, lockForwards: false, discussionChatId: "-100000000002" };
