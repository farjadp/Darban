...
const messageSchema = z.object({ message_id: z.number().int(), date: z.number().optional(), chat: chatSchema, from: userSchema.optional(), sender_chat: chatSchema.optional(), text: z.string().optional(), is_automatic_forward: z.boolean().optional() });
