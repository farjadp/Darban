...
export function AdminForm(props: Props) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    if (props.operation === "settings") payload = { ...payload, waitHours: Number(fields.get("waitHours")), verification: fields.get("verification") === "on", commentGate: fields.get("commentGate") === "on", deleteJoinMessages: fields.get("deleteJoinMessages") === "on", lockCommands: fields.get("lockCommands") === "on", lockLinks: fields.get("lockLinks") === "on", lockMedia: fields.get("lockMedia") === "on", lockForwards: fields.get("lockForwards") === "on", lockEmoji: fields.get("lockEmoji") === "on", lockEmptyEmoji: fields.get("lockEmptyEmoji") === "on", discussionChatId: String(fields.get("discussionChatId") ?? "").trim() || null };
